...
@implementation SLUrlCacheModel

#pragma mark - For NSURLProtocol
+ (SLUrlCacheModel *)shareInstance {
    static SLUrlCacheModel *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[SLUrlCacheModel alloc] init];
    });
    return instance;
}
...
- (NSString *)cacheRequestFileName:(NSString *)requestUrl {
    return [SLUrlCacheModel md5Hash:[NSString stringWithFormat:@"%@",requestUrl]];
}
- (NSString *)cacheRequestOtherInfoFileName:(NSString *)requestUrl {
    return [SLUrlCacheModel md5Hash:[NSString stringWithFormat:@"%@-otherInfo",requestUrl]];
}
