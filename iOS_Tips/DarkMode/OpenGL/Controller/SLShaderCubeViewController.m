...
-(void)renderLayer {
    @autoreleasepool {
        ...
        //2.读取顶点着色程序、片元着色程序
        //3.读取/加载/编译shader
        self.myPrograme = [self loadShaders:vertexShaderString Withfrag:fragmentShaderString];
        //4.链接
        ...
        //11.创建4 * 4投影矩阵  把三维空间视图透视投影到二维平面上  https://www.jianshu.com/p/3448f546eac4
